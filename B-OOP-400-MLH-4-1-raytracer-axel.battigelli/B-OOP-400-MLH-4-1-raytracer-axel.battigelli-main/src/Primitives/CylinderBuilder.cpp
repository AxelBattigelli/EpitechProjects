...
Raytracer::Primitives::CylinderBuilder::CylinderBuilder(const libconfig::Setting &contentList)
{
...
Raytracer::Primitives::CylinderBuilder &Raytracer::Primitives::CylinderBuilder::setCenter(Point3 center) 
{
    this->_center = center;
    return *this;
}

Raytracer::Primitives::CylinderBuilder &Raytracer::Primitives::CylinderBuilder::setUpNormal(Vector3 upNormal)
{
    this->_upNormal = upNormal;
    return *this;
}

Raytracer::Primitives::CylinderBuilder &Raytracer::Primitives::CylinderBuilder::setLength(double length)
{
    this->_length = length;
    return *this;
}

Raytracer::Primitives::CylinderBuilder &Raytracer::Primitives::CylinderBuilder::setRadius(double radius)
{
    this->_radius = radius;
    return *this;
}

Raytracer::Primitives::CylinderBuilder &Raytracer::Primitives::CylinderBuilder::setMaterial(std::shared_ptr<IMaterial> material)
{
    this->_material = material;
    return *this;
}

Raytracer::Primitives::Cylinder Raytracer::Primitives::CylinderBuilder::build() const 
{
    return Cylinder(this->_center, this->_upNormal, this->_length, this->_radius, this->_material);
}
