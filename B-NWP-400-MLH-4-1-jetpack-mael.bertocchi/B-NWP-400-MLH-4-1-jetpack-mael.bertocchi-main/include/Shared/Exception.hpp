...
namespace Jetpack::Shared {
     ...
     *
     * This class provide debugging information, including the location where
    ...
    class Exception : public std::exception {
        public:
             ...
             */
            Exception(const std::string& what, const std::source_location& where = std::source_location::current());
